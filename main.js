...
document.addEventListener('click', event => {
    if (event.target.matches ('.details-link')){
        ...
        //Debugging
        console.log("EventListener klappt.");
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                        ...
                        <div class="row row-cols-2 g-4">
                            ...
                            <div>
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>methods</td>
                                        <td>${beer.method.mash_temp.value}<${beer.method.mash_temp.unit}</td>
                                    </tr>
                                    <tr>
                                        <td>fermentation</td>
                    ...
                    <div class="modal-footer">
                        <p><small>Contributed by PinkCrocodilo</small></p>
